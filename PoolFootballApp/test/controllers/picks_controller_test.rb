...
class PicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post picks_url, params: { pick: { pickstring: @pick.pickstring, pool_id: @pick.pool_id, pooler_id: @pick.pooler_id, season: @pick.season, week: @pick.week } }
    end
  ...
  test "should update pick" do
    patch pick_url(@pick), params: { pick: { pickstring: @pick.pickstring, pool_id: @pick.pool_id, pooler_id: @pick.pooler_id, season: @pick.season, week: @pick.week } }
